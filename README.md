# Friday Night Funkin': This GC's Insanity (Source code build) - Codename Engine (WIP)
...
- Credits to [CodenameCrew](https://github.com/CodenameCrew) for the engine we based TGCI on
